...
operates outside the official managed infrastructure of the agency.
...
1. **Education:**
    ...
    - Offer alternatives if the app isn't working (e.g., using a **FOB** device or the patient's landline phone).
2. **Official Warning:**
    - If the refusal continues, send a standardized message citing the **DOH (Department of Health)** mandate.
3. **Ultimatum:**
